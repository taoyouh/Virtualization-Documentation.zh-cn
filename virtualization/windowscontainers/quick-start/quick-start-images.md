...
ms.locfileid: "10138498"
---
# <a name="automating-builds-and-saving-images"></a>自动生成和保存图像
...
- 通过 Windows 容器功能和 Docker 配置此系统。 有关这些步骤的演练，请参阅[入门：配置容器的环境](../quick-start/set-up-environment.md)。
