...
>[!NOTE]
> \ * Windows Server 后, 版本1709不再受支持。 有关详细信息, 请参阅[基本图像服务生命周期](base-image-lifecycle.md)。
...
## <a name="windows-server-2016-host-os-compatibility"></a>Windows Server 2016 主机操作系统兼容性
