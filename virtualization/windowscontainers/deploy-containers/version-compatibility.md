...
Windows Server 容器当前不支持基于 Windows Server 2016 的容器在容器主机和容器映像的修订号不同的系统中运行的方案。 例如，如果容器主机版本为10.0.14393。**1914** （应用了 KB4051033 的 Windows Server 2016）和容器映像的版本为10.0.14393。**1944** （应用了 KB4053579 的 Windows Server 2016），则映像可能无法启动。
...
>[!NOTE]
>在2020年2月11日的安全更新版本（也称为 "2B"）或更高的每月安全更新版本中使用 Windows Server 容器时，可能会遇到问题。 有关更多详细信息，请参阅[此文](https://support.microsoft.com/help/4542617/you-might-encounter-issues-when-using-windows-server-containers-with-t)。  
>
>我们强烈建议你将主机和容器更新为最新的修补程序和更新，以保持安全和兼容。 有关如何更新 Windows 容器的重要指导，请参阅[更新 Windows Server 容器](update-containers.md)。
